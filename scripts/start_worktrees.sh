...
# [2/5] パイプライン選択
# =============================================================================
echo -e "${YELLOW}[2/5] 起動するパイプラインを選択してください...${NC}"
echo ""
...
# =============================================================================
# [3/5] 前回メッセージのアーカイブ → inboxリセット
# =============================================================================
echo -e "${YELLOW}[3/5] 前回メッセージのアーカイブ...${NC}"
...
# =============================================================================
# [4/5] メッセージキュー初期化 / Worktree確認・作成
# =============================================================================
echo -e "${YELLOW}[4/5] メッセージキュー初期化 & Worktree確認...${NC}"
